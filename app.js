...
const FALLBACK_BINS = {
    ...
    "Link (Link's Awakening)": "",
    "Green Yarn Yoshi": "",
    "Pink Yarn Yoshi": "",
    "Light-Blue Yarn Yoshi": "",
    "Mega Yarn Yoshi": "",
    "Poochy": "",
    "Gakuto Sōgetsu": "",
    "Gakuto Sogetsu": "",
    "Tatsuhisa “Luke” Kamijō": "",
    "Tatsuhisa \"Luke\" Kamijo": "",
    "Yuga Ohdo": "",
    "Romin Kirishima": "",
    "Roa Kirishima": "",
    "Nail Saionji": "",
    "Asana Mutsuba": ""
};
...
const TRANSLATIONS = {
    es: {
        ...
        btn_donate: "Donar",
        btn_donate_footer: "Apoyar / Donar",
        btn_donate_title: "Apoyar el proyecto en Ko-fi",
        footer_developed_by: 'Desarrollado en <svg width="15" height="11" viewBox="0 0 640 480" style="border-radius: 2px; vertical-align: middle; display: inline-block; margin: 0 2px;"><path fill="#0039a6" d="M0 0h213.3v240H0z"/><path fill="#fff" d="M213.3 0H640v240H213.3z"/><path fill="#d52b1e" d="M0 240h640v240H0z"/><path fill="#fff" d="m106.7 54 18.5 56.9h59.9l-48.5 35.2 18.5 56.9-48.4-35.2-48.5 35.2 18.5-56.9-48.5-35.2h59.9z"/></svg> con <span style="color: #ff5e5b;">♥</span> por',
        ...
        scanning_modal_title: "🔍 Escaneando Allmiibo...",
        scanning_modal_sub: "Verificando figuras ya instaladas",
        scanning_banner_text: "Iniciando verificación de memoria...",
        ...
        help_device_intro_desc: "Allmiibo es un emulador físico de figuras y tarjetas Amiibo de Nintendo con pantalla OLED/LCD y Bluetooth integrado para tu Nintendo Switch 1 y 2, Wii U o 3DS.",
        help_aliexpress: "🛒 Disponible en AliExpress",
        help_tutorial_title: "Tutorial de Uso Rápido",
        help_step1_title: "1️⃣ Activar Bluetooth en tu Allmiibo:",
        help_step1_desc: "En el menú principal de tu Allmiibo, deslízate hasta la opción BT transmission (Transferencia Bluetooth) y selecciónala para ponerla en ON y permitir la conexión.",
    ...
    en: {
        ...
        btn_donate: "Donate",
        btn_donate_footer: "Support / Donate",
        btn_donate_title: "Support the project on Ko-fi",
        footer_developed_by: 'Developed in <svg width="15" height="11" viewBox="0 0 640 480" style="border-radius: 2px; vertical-align: middle; display: inline-block; margin: 0 2px;"><path fill="#0039a6" d="M0 0h213.3v240H0z"/><path fill="#fff" d="M213.3 0H640v240H213.3z"/><path fill="#d52b1e" d="M0 240h640v240H0z"/><path fill="#fff" d="m106.7 54 18.5 56.9h59.9l-48.5 35.2 18.5 56.9-48.4-35.2-48.5 35.2 18.5-56.9-48.5-35.2h59.9z"/></svg> with <span style="color: #ff5e5b;">♥</span> by',
        ...
        scanning_modal_title: "🔍 Scanning Allmiibo...",
        scanning_modal_sub: "Checking already installed figures",
        scanning_banner_text: "Starting device storage scan...",
        ...
        help_device_intro_desc: "Allmiibo is a physical Nintendo Amiibo emulator with an OLED/LCD screen and built-in Bluetooth for your Nintendo Switch 1 & 2, Wii U, or 3DS.",
        help_aliexpress: "🛒 Available on AliExpress",
        help_tutorial_title: "Quick Start Tutorial",
        help_step1_title: "1️⃣ Enable Bluetooth on your Allmiibo:",
        help_step1_desc: "On your Allmiibo main menu, scroll down to the BT transmission option and select it to turn it ON to allow connection.",
                    ...
                    if (isAwakening) {
                        ...
                        if (!fileObj) {
                            for (const [key, b64] of Object.entries(FALLBACK_BINS)) {
                                ...
                                const normLocal = normalizeString(item.localPath || "");
                                const normUrl = normalizeString(item.githubUrl || "");
                                if (normLocal.includes(normKey) || normKey.includes(normLocal) || (normKey && normUrl.includes(normKey))) {
                                    const byteChars = atob(b64);
                                    const byteNums = new Uint8Array(byteChars.length);
                                    for (let i = 0; i < byteChars.length; i++) {
                                        byteNums[i] = byteChars.charCodeAt(i);
...
function showUploadReportModal() {
    ...
    // Automatically clear completed items from the upload queue in sidebar
    if (errorItems.length === 0) {
        state.uploadQueue = [];
        renderUploadQueue();
    } else {
        // Keep only failed items in queue so sidebar is clean
        state.uploadQueue = errorItems;
        renderUploadQueue();
    }
...
// Scan Installed Button in Catalogue Toolbar
document.getElementById("btn-cat-scan-installed")?.addEventListener("click", () => {
    if (!state.isConnected) {
        showToast("Conecta tu Allmiibo para escanear las figuras instaladas.", "error");
        return;
    }
    scanInstalledAmiibos();
});
